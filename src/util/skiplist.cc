...
static inline bool _sl_valid_node(skiplist_node *node) {
    atm_bool is_fully_linked = false;
                                ...
                                skiplist_node *node)
{
    ...
    atm_bool bool_true = true, bool_false = false;
    atm_bool removed = false;
    atm_bool is_fully_linked = false;
